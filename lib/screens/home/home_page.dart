...
import 'components/accounts_app_bar.dart';
import 'components/accounts_tab.dart';
import 'components/budget_app_bar.dart';
import 'components/budget_tab.dart';
import 'components/preview_app_bar.dart';
import 'components/preview_tab.dart';
import 'components/settings_app_bar.dart';
import 'components/settings_tab.dart';
import 'components/spendings_app_bar.dart';
import 'components/spendings_tab.dart';
...
class _HomePageState extends State<HomePage>
  ...
  List<Widget> _buildTabsContent(BuildContext context) {
    ...
    map[EnvelyTabPosition.SettingsTab.index] = SettingsTab();
